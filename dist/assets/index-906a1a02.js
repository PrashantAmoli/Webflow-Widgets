...
`;window.addEventListener("load",()=>{document.querySelectorAll(".info-widget").forEach(t=>{const e=t.querySelector(".info-widget-heading").innerText,s=t.querySelector(".info-widget-content").innerText,n=t.querySelector(".widget-type").innerText.toLowerCase().trim();console.log(n),n==="warn"?t.innerHTML=l.warn(e,s):n==="danger"?t.innerHTML=l.danger(e,s):t.innerHTML=l.info(e,s)})});const l={info:(t,e)=>`
  <div
